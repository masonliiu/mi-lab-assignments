...
namespace Oculus.Interaction.Locomotion
{
        ...
        ILocomotionEventHandler, IDeltaTimeConsumer, ITimeConsumer
    {
        ...
        /// </summary>
        [SerializeField]
        [Tooltip("The CharacterController representing the character that is used to move the player around the scene.")]
        ...
        /// </summary>
        [SerializeField]
        [Tooltip("Root of the actual VR player so it can be sync with the CharacterController. If you provided a _playerEyes you must also provide a _playerOrigin.")]
